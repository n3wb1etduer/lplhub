		...
		<div class="header" id="home1">
			<div class="container">
				...
				font-size: 120%;">
					...
					<a href="http://localhost:8099/Cart/manager_login.jsp" style="border:none;height: 60px;width: 80px;color: black;"><i class="fa fa-sign-in" style="font-size: 200%;"></i><br />管理员登录</a>
					<!--登录跳转-->
				</div>
				<div class="w3l_login" style="
				margin: 20px 40px;
				...
				font-size: 120%;">
					...
					<a href="index.html" style="border:none;height: 60px;width: 80px;color: black;"><i class="fa fa-sign-out" style="font-size: 200%;color: black;"></i><br />退出登录</a>
				</div>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							...
							<!-- Mega Menu -->
							<li class="dropdown">
								<a href="http://localhost:8099/Cart/manager.jsp" >会员管理 </a>
		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="thumbnail">
							<img alt="不显示提示" src="<%=p.getCOVER()%>" style="width:300px;height:300px;"/>
						<div class="video" style="height:320px;">
								<h3>电影名:<%=p.getTITLE()%></h3>
								<h3>导演:<%=p.getMAJOR()%></h3>
								<h3>上映日期:<%=p.getYEAR()%></h3>
								<h3>影片价格:<%=p.getPRICE()%></h3>
								
								
								
								
								<p>
									<a class="btn btn-primary" href="ManagerDelServlet?RANK=<%=p.getRANK() %>">删除商品</a> 								
								</p>
