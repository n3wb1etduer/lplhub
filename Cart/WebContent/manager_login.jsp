...
<div class="about">
    <div class="container">
        <div class="register">
            <form class="form-horizontal" role="form"  action = "http://localhost:8099/Cart/ManagerLoginServlet"  method="post">
                <div class="register-top-grid">
                    <h3>MANAGER PERSONAL INFORMATION</h3>
                    <div >
                        <span>Email/Telephone/QQ/WeChat<label> *</label></span>
                        <input type="text" name="email" size="2000">
                    </div>
